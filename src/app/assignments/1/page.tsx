...
export default function Assignment1() {
  ...
  const products = [
    ...
    {
      imageSrc:
        "https://src.hidoc.co.kr/image/lib/2021/6/24/1624517344477_0.jpg",
      title: "복숭아",
      price: 15000,
    },
    {
      imageSrc:
        "https://www.nongmin.com/-/raw/srv-nongmin/data2/content/image/2022/02/13/.cache/512/20220213191115.jpg",
      title: "딸기",
      price: 25000,
    },
  ];
  ...
  function 상품을만드는함수() {
    return products.map((p) => (
      <상품 imageSrc={p.imageSrc} title={p.title} price={p.price} />
    ));
  }
